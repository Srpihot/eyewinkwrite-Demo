...
public class MyAdapter extends ListAdapter<Word,MyAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View itemViem;
        if(useCardView){
            itemViem=layoutInflater.inflate(R.layout.cell_card_2,parent,false);
        }
        else{
            itemViem=layoutInflater.inflate(R.layout.cell_normal_2,parent,false);
        }
        final MyViewHolder holder = new MyViewHolder(itemViem);
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            aSwitchChineseInvisible=itemView.findViewById(R.id.aSwitchChineseInvisible);
